 ...
 * @author hongd
 */
@WebServlet(name = "productDetails", urlPatterns = {"/product"})
public class productDetails extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if (pid != null) {
                ProductDetails pds = dao.getInfoById(pid);
                List<Color> c = dao.getColorById(pid);
                List<Storage> s = dao.getStorageById(pid);
                Products pd = dao.getProductById(pid);
                ...
                request.setAttribute("price", f.Currency(pd.getPrice()));
