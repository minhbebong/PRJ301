                    ...
                    <div class="col-12 content">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <form action="admin-profilemanage" method="POST">
                                    <tr>
                                        <th scope="row">${id}</th>
                                        <td><input type="text" value="${u.username}" name="user" readonly=""></td>
                                        <td><input type="password" value="${u.password}" name="pass"></td>
                                        <td><input type="text" value="${u.email}" name="email"></td>
                                        <td><input type="text" value="${u.phone}" name="phone"></td>
                                        <td>
                                            <select name="role" id="">
                                                <option value="sa" <c:if test="${u.role == 'sa'}">
                                                        selected
                                                    </c:if>>admin</option>
                                                <option value="us" <c:if test="${u.role == 'us'}">
                                                        selected
                                                    </c:if>>user</option>
                                                <option value="bl" <c:if test="${u.role != 'us' && u.role != 'sa'}">
                                                        selected
                                                    </c:if>>block</option>
                                            </select>
                                        </td>
